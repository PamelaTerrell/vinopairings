...
export default function CelestialSipsPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: brand.cream, color: brand.cocoa }}>
      <main id="top" className="mx-auto w-full max-w-6xl px-6 py-12 md:py-16">
        ...
        >
          ...
          <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-10">
            ...
            <div className="shooting-star" style={{ top: '58%', left: '60%', animationDelay: '8.1s',  animationDuration: '4.0s' }} />
            <div className="shooting-star" style={{ top: '22%', left: '40%', animationDelay: '11.4s', animationDuration: '3.4s' }} />
          </div>
        ...
        >
          ...
          <h2 className="text-3xl font-serif font-bold tracking-wide text-center">
            ...
            <span style={{ color: brand.gold }}>{season}</span>
          </h2>
        ...
        <section className="mt-14 grid gap-6 sm:gap-8 grid-cols-[repeat(auto-fit,minmax(260px,1fr))]">
          {signs.map(([slug, name, wine, note]) => (
            <a
              ...
              data-sign={name}
            >
              <h3 className="text-xl font-serif font-bold text-[#a37c58]">
                {name}
              </h3>
        ...
        {/* READ MORE SECTION */}
        <section
          className="mt-16 rounded-2xl border p-8 shadow-sm relative"
          style={{ backgroundColor: brand.parchment, borderColor: brand.line }}
        >
          <h2 className="text-3xl font-serif font-bold tracking-wide text-center">
            Read More
          ...
          {/* Table of Contents */}
          <nav
            aria-label="Zodiac table of contents"
              ...
              {signs.map(([slug, name]) => (
                <li key={slug}>
                  <a
                    href={`#${slug}`}
                    data-sign={name}
                    className="block rounded-md px-3 py-2 text-sm hover:bg-[#fdfaf3] transition-colors"
                    style={{ color: brand.cocoa }}
                  >
                    {name}
                  </a>
                </li>
          ...
          <div className="mt-8 space-y-10">
            {signs.map(([slug, name, wine, , essay]) => (
              <article
                key={slug}
                id={slug}
                className="rounded-xl border bg-white p-6 shadow-sm scroll-mt-24"
                style={{ borderColor: brand.line }}
              >
                <header className="flex flex-wrap items-baseline gap-3">
                  ...
                  <span
                    ...
                    style={{ borderColor: brand.line, color: brand.gold }}
                  >
                    {wine}
                  </span>
                </header>
          ...
          {/* Floating "Back to Gallery" button (visibility handled by globals.css) */}
          <a
            href="#top"
            id="backToGallery"
      ...
      {/* GA4 event tracking + essay state toggle */}
      <script
