    ...
    <div className="min-h-screen bg-[#f9f6ef] text-[#4b3f2f]">
      <main className="mx-auto max-w-3xl px-6 py-14">
        ...
        <header className="text-center">
          <h1 className="text-4xl md:text-5xl font-semibold tracking-wide [font-family:var(--font-playfair)]">
            Privacy Policy
          </h1>
        ...
        <div className="mt-10 space-y-10 text-[17px] leading-8 text-[#5a4636]">
          ...
          <section>
            ...
            <p>
              ...
              may be collected automatically through analytics and standard
              web technologies.
            </p>
          ...
          <section>
            ...
            <p>
              ...
              understand how visitors use the site. This helps improve
              content, performance, and user experience.
            </p>

            <p>
              The site may use services such as Google Analytics and
              Vercel Analytics. These tools may collect information
              including pages visited, time spent on pages, device
              information, and general location.
            </p>

            <p>
              This information is analyzed in aggregate and is not used
              to personally identify individual visitors.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Some pages may contain affiliate links. If you purchase a
              product through an affiliate link, Vino Pairings may earn a
              small commission at no additional cost to you.
            </p>

            <p>
              Affiliate partners may use their own cookies or tracking
              technologies when you visit their sites. Please review
              those websites' privacy policies for details.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Vino Pairings may use third-party services to operate and
              improve the website, including web hosting, analytics
              tools, and affiliate platforms.
            </p>

            <p>
              These providers may process limited technical data required
          ...
          <section>
            ...
            <p>
              You may control cookies through your browser settings. If
              a cookie notice appears on this site, you may also use it
              to manage analytics preferences where available.
            </p>

            <p>
              Disabling certain technologies may affect how parts of the
              site function.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Vino Pairings is not directed toward children under the
              age of 13 and does not knowingly collect personal
          ...
          <section>
            ...
            <p>
              ...
              changes in site functionality, legal requirements, or
              business practices. Updates will be posted on this page.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Questions about this policy may be directed through the
              contact information available on the Vino Pairings website.
            </p>
          </section>
